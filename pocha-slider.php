...
/*
	Plugin Name: Pocha Slider
	Author: Justin Allison
	Author URI: http://raihanb.com/gain
	Description: This plugin will enable Pocha Slider in your WordPress site. You can change lots of options from Option Panel.
	Plugin URI: http://raihanb.com/gain/pocha-slider
	Version: 1.0	
...
class Easing_Slider {
	...
	protected function register_post_type() {
		...
		register_post_type( 'easingslider', array(
			...
			'show_ui'             => false,
			'labels'              => array(
				'name' => __( 'Pocha Slider', 'pochaslider' )
			)
		) );
